...
import 'package:my_pickup/jobdetaildone.dart';
...
class _MyPostState extends State<MyPost> {
                                    ...
                                    decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            ...
                                            image: new NetworkImage(
                                                "http://pickupandlaundry.com/my_pickup/chan/profile/${widget.driver.email}.jpg")
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "http://pickupandlaundry.com/my_pickup/chan/php/loadrequest.php";
  ...
  void _onJobDetail(
    ...
    Navigator.push(context, SlideRightRoute(page: JobDetailDone(job: job, driver: widget.driver)));
  }
  ...
  void _prepareJob() {
    ...
    if (jobName.isEmpty ||
      ...
      if (widget.driver != null) {
        _uploadJob(widget.driver.email, jobName, price, description, location,
            destination, widget.driver.credit);
      } else {
  ...
  void _uploadJob(
    ...
    String url = 'http://pickupandlaundry.com/my_pickup/chan/php/uploadjob.php';
  ...
  Future<String> deleteRequest(String job_id) async {
    String urlLoadJobs = "http://pickupandlaundry.com/my_pickup/chan/php/deletejob.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
